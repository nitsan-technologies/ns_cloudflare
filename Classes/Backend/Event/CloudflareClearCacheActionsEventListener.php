...
namespace NITSAN\NsCloudflare\Backend\Event;
...
class CloudflareClearCacheActionsEventListener
{
    ...
    public function __invoke(ModifyClearCacheActionsEvent $event): void
    {
        ...
        $event->addCacheAction([
            'id' => 'clns_cloudflareoudflare',
            'title' => 'LLL:EXT:ns_cloudflare/Resources/Private/Language/locallang.xlf:clear_cache',
            'description' => 'LLL:EXT:ns_cloudflare/Resources/Private/Language/locallang.xlf:clear_cache.description',
            'href' => $this->uriBuilder->buildUriFromRoute('ajax_cloudflare_purge'),
            'iconIdentifier' => 'actions-system-cache-clear-impact-low',
        ]);
        $event->addCacheActionIdentifier('ns_cloudflare');
    }
    ...
    private function canClearCache(): bool
    {
        ...
        $canClearCloudflareCache = (bool)($backendUser->getTSConfig()['options.']['clearCache.']['ns_cloudflare'] ?? false);
